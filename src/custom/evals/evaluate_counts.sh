...
for signal in $sample_signals; do
	...
	# 	truth_out="data/evaluate_signal/${method}_${condition}_${replicate}_${mark}_${fpr}.pred-truth.txt"
	# 	echo "$predicted_truth" > $truth_out
	# 	false_out="data/evaluate_signal/${method}_${condition}_${replicate}_${mark}_${fpr}.pred-false.txt"
