...
rule evaluate_seacr_relaxed_consensus:
	input:
...
rule evaluate_seacr_stringent_consensus:
	input:
...
rule evaluate_gopeaks_consensus:
	input:
		# "data/gopeaks_signal/{sample}.bed"
...
# rule evaluate_normalized_signal_consensus:
# 	input:
