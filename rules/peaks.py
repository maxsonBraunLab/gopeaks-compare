...
rule seacr_relaxed:
	...
	shell:
		"bash {input.seacr} {input.sample} {params.igg} {params.norm} relaxed data/seacr/{wildcards.sample} > {log} 2>&1"
...
rule seacr_stringent:
	...
	shell:
		"bash {input.seacr} {input.sample} {params.igg} {params.norm} stringent data/seacr/{wildcards.sample} > {log} 2>&1"
